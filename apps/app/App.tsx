...
function ReminderEditor({
  ...
  return (
    ...
    >
            ...
            <View style={styles.chips}>
              {(["default", "silent", "vibrate"] as const).map((mode) => (
                <Button
                  ...
                  label={
                    mode === "default"
                      ? copy(locale, "Default", "Padrão")
                      : mode === "silent"
                        ? copy(locale, "Silent", "Silencioso")
                        : copy(locale, "Vibrate", "Vibrar")
                  }
      ...
      {Boolean(error) && <Notice tone="danger" colors={colors} text={error} />}
      <View
        style={[
